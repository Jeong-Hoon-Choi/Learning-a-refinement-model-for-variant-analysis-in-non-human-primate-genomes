...
# data_2 = pd.read_csv(data_dir + 'HG001_concat_all_.csv', index_col=0)
# data_1 = pd.read_csv(data_dir + 'HG002_concat_all_.csv', index_col=0)
...
# data_train.to_csv(data_dir + 'mixed_train.csv')
# data_test.to_csv(data_dir + 'mixed_test.csv')
