...
if __name__ == '__main__':
    for m in mode_all:
        ...
        ablation_dict = {'wo_dvr_alignment': dv_feature,
                         'wo_dvr': dv_feature + alignment_feature,
                         'wo_alignment': dv_feature + dv_result_feature,
                         'all_info': dv_feature + dv_result_feature + alignment_feature}

        for tag in ablation_dict:
            feature_less = ablation_dict[tag]
